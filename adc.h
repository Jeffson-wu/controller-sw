...
#define ADC_PIN_CH_0 GPIO_Pin_6
#define ADC_PIN_CH_1 GPIO_Pin_7
#define ADC_PIN_CH_2 GPIO_Pin_5
#define ADC_PIN_CH_3 GPIO_Pin_0

/*
#define ADC_MUX_CH_0 ADC_Channel_0 // OLD SETUP, IS INCORRECT
